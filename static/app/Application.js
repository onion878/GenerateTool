...
function setDefaultUrl() {
    ...
    request('https://cdn.jsdelivr.net/gh/onion878/GenerateTool/package.json', function (error, response, body) {
        try {
            ...
            if (d.version != oldVersion) {
                ...
                utils.downloadFile(`GenerateTool-Setup-v${d.version}.exe`, `GenerateTool-Setup-v${d.version}.exe`, d.url).then(d => {
